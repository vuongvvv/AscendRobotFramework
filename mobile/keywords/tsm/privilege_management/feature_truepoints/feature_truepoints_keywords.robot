...
Resource    ../../../../resources/locators/tsm/privilege_management/feature_truepoints/feature_truepoints_locators.robot
...
Tap On Print Receipt
    ...
    Run Keyword If      '${OS_NAME}' == 'android'    Page Should Contain Property With Value   ${print_screen_label_second_android}
    Run Keyword If      '${OS_NAME}' == 'ios'        Page Should Contain Property With Value   ${print_screen_label_second_ios}
    Run Keyword If      '${OS_NAME}' == 'android'    Page Should Contain Property With Value   ${print_screen_label_third_android}
    Run Keyword If      '${OS_NAME}' == 'ios'        Page Should Contain Property With Value   ${print_screen_label_third_ios}
