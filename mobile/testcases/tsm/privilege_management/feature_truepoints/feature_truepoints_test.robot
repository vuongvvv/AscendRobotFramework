...
TC_01
    ...
    Run Keyword If      '${OS_NAME}' == 'ios'        Page Should Contain Property With Value    ${summary_tid_ios}
    Run Keyword If      '${OS_NAME}' == 'ios'        Page Should Contain Property With Value    ${summary_mid_ios}
    Run Keyword If      '${OS_NAME}' == 'android'    Page Should Contain Property With Value    ${summary_tid_android}
    Run Keyword If      '${OS_NAME}' == 'android'    Page Should Contain Property With Value    ${summary_mid_android}
