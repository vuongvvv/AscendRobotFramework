...
Resource            ../../../../keywords/tsm/privilege_management/summary_reports/summary_report_keywords.robot
Resource            ../../../../keywords/tsm/registration_privilege/activation_code/activation_code_keywords.robot
Resource            ../../../../keywords/tsm/privilege_management/on_boarding/on_boarding_keywords.robot
Resource            ../../../../keywords/tsm/privilege_management/feature_truepoints/feature_truepoints_keywords.robot
...
TC_01
    ...
    Run Keyword If      '${OS_NAME}' == 'ios'        Page Should Contain Property With Value    ${settlement_tid_ios}
    Run Keyword If      '${OS_NAME}' == 'ios'        Page Should Contain Property With Value    ${settlement_mid_ios}
    Run Keyword If      '${OS_NAME}' == 'android'    Page Should Contain Property With Value    ${settlement_tid_android}
    Run Keyword If      '${OS_NAME}' == 'android'    Page Should Contain Property With Value    ${settlement_mid_android}
...
TC_02
    ...
    View Summary Report
    Run Keyword If      '${OS_NAME}' == 'android'    Element Text Should Be         &{summary_screen}[lbl_total_point]      ${new_truepoint_number}
    Run Keyword If      '${OS_NAME}' == 'android'    Element Text Should Be         &{summary_screen}[lbl_total_baht]       ${new_total_baht}
    Run Keyword If      '${OS_NAME}' == 'ios'        Page Should Contain Property With Value        ${new_truepoint_number}
