...
Test Setup    Run Keywords    Generate Gateway Header With Scope and Permission    ${ROLE_USER}    ${ROLE_USER_PASSWORD}    scope=merchantTx.create,sms.read    permission_group_name=Notification Template Admin Group,Notification History Admin Group    AND    Get Template Id    action.equals=TY_REJECT&type.equals=SMS    AND    Put Update Template Status    { "id": ${TEST_DATA_TEMPLATE_ID}, "status": "ACTIVE" }
