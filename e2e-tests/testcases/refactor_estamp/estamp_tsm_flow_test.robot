...
...              And TSM Merchant can approve issue stamp and redeem reward
...
TC_O2O_05081
    ...
    [Tags]      EStamp      Regression      High      E2E       SanityExclude      Smoke
...
TC_O2O_04774
    [Documentation]    TSM Merchants approve issued stamp 1 position to user's
    [Tags]      EStamp      Regression      High      E2E       SanityExclude      Smoke
    Login As Merchants On TSM
...
TC_O2O_04775
    [Documentation]    TSM Merchants approve issued stamp 2 positions to user's
    [Tags]      EStamp      Regression      High      E2E       SanityExclude      Smoke
    Login As Merchants On TSM
    TSM Merchant Use Unique Code To Approve Issued Stamp     ${generate_uniquecode_code}
    Response Correct Code      ${SUCCESS_CODE}
...
TC_O2O_04816
    [Documentation]    TSM Merchants approve redeemed extra reward to user's
    [Tags]      EStamp      Regression      High        E2E     SanityExclude      Smoke
    Login As Merchants On TSM
...
TC_O2O_05083
    [Documentation]    TSM Merchants approve issued stamp 3 positions to user's get main reward
    [Tags]      EStamp      Regression      High      E2E       SanityExclude      Smoke
    Login As Merchants On TSM
    TSM Merchant Use Unique Code To Approve Issued Stamp     ${generate_uniquecode_code}
    Response Correct Code      ${SUCCESS_CODE}
...
TC_O2O_05085
    [Documentation]    TSM Merchants approve redeemed main reward to user's
    [Tags]      EStamp      Regression      High        E2E     SanityExclude      Smoke
    Login As Merchants On TSM
    TSM Merchant Use Unique Code To Approve Redeem Reward    ${generate_redeem_code}
    Response Correct Code      ${SUCCESS_CODE}
