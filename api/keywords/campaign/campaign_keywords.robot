...
Get All Campaign Under Merchant Type
    ...
    Set Test Variable    ${RESP}
    Response Should Contain All Property Values Contain    .type        merchant
    Response Should Contain All Property Values Contain    .group       ${campaign_group}
...
Get All Campaign Under Customer Type
    ...
    Set Test Variable    ${RESP}
    Response Should Contain All Property Values Contain    .type        customer
    Response Should Contain All Property Values Contain    .group       ${campaign_group}
