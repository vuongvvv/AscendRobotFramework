...
Resource    ../mapping/mapping_keywords.robot
...
Prepare External Ids
    ...
    Generate Gateway Header With Scope and Permission    ${ROLE_USER}    ${ROLE_USER_PASSWORD}    permission_name=mapping.mapping.actAsAdmin
