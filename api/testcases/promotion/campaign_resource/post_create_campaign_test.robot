...
Test Setup    Generate Gateway Header With Scope and Permission   ${ROLE_USER}    ${ROLE_USER_PASSWORD}    scope=camp.camp.w
...
TC_O2O_07087
    ...
    Response Should Contain Property With Value  $.endDate    2019-12-31T16:59:00Z
...
TC_O2O_07088
    ...
    [Tags]  ASCO2O-6  ASCO2O-7  ASCO2O-9  Hawkeye-2019S01    Regression    High    Sanity
    Post Create Project     {"name": "${project_name}","code": "${project_code}","description": "${project_description}"}
    Get Created ProjectID From Response
    ${refCode} =	Generate Random String	${refcode_length}
    Read Json From File   ${create_campaign_gencoupon_json_data}
