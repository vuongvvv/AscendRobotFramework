...
Test Setup    Run Keywords    Prepare Campaign For Test    AND    Generate Gateway Header With Scope and Permission    ${SUPER_ADMIN_USER}    ${SUPER_ADMIN_PASSWORD}    campaign.usage.create
Test Teardown    Run Keywords    Delete Created Client And User Group    AND    Delete All Sessions

*** Test Cases ***
TC_O2O_04682
    [Documentation]    Verify that user cannot call API without "campaign.usage.create" scope
    [Tags]    BE-Campaign    regression    High
...
TC_O2O_04683
    ...
    [Tags]    BE-Campaign    regression    High    Smoke
    Update Usage With New CampaignID    ${campaign_id}
    Keep Track Campaign Usage By User    ${json_dummy_data}
