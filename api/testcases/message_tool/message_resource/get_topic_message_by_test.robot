...
TC_O2O_08020
    ...
    [Tags]    Regression    High    Smoke    UnitTest    Sanity    ASCO2O-574
    [Setup]    Generate Gateway Header With Scope and Permission    ${ROLE_USER}    ${ROLE_USER_PASSWORD}    permission_name=point.msg.dlq-l
...
TC_O2O_03297
    ...
    [Tags]    Regression    High    Smoke    UnitTest    Sanity    ASCO2O-574
    [Setup]    Generate Gateway Header With Scope and Permission    ${ROLE_USER}    ${ROLE_USER_PASSWORD}    permission_name=point.msg.actAsAdmin
    [Template]    Get Message From Kafka Topic With Correct Permission
    ${ENV}.point-calculation
    ${ENV}.issue-point
    ${ENV}.payment-transaction
...
TC_O2O_08024
    ...
    [Tags]    Regression    High    Smoke    UnitTest    Sanity    ASCO2O-574
    [Setup]    Generate Gateway Header With Scope and Permission    ${ROLE_USER}    ${ROLE_USER_PASSWORD}    permission_name=merchantPublisher.msg.actAsAdmin
    [Template]    Get Message From Kafka Topic With Correct Permission
...
TC_O2O_08027
    ...
    [Tags]    Regression    High    Smoke    UnitTest    Sanity    ASCO2O-574
    [Setup]    Generate Gateway Header With Scope and Permission    ${ROLE_USER}    ${ROLE_USER_PASSWORD}    permission_name=merchantPublisher.msg.dlq-l
    [Template]    Get Message From Kafka Topic With Incorrect Permission
    ${ENV}.merchantPub-merchant
    ${ENV}.merchantPub-outlet
    ${ENV}.merchantPub-terminal
...
TC_O2O_08029
    ...
    [Tags]    Regression    High    Smoke    UnitTest    Sanity    ASCO2O-574
    [Setup]    Generate Gateway Header With Scope and Permission    ${ROLE_USER}    ${ROLE_USER_PASSWORD}    permission_name=merchantSubscriber.msg.actAsAdmin
    [Template]    Get Message From Kafka Topic With Correct Permission
...
TC_O2O_08031
    ...
    [Tags]    Regression    High    Smoke    UnitTest    Sanity    ASCO2O-574
    [Setup]    Generate Gateway Header With Scope and Permission    ${ROLE_USER}    ${ROLE_USER_PASSWORD}    permission_name=merchantSubscriber.msg.dlq-l
    [Template]    Get Message From Kafka Topic With Correct Permission
    ${ENV}.error-merchantSub-activation-notification.sentSms
    ${ENV}.error-merchantSub-activation-notification.sentEmail
    ${ENV}.error-merchantSub-outlet-trueyou.trueYouOutletProcessConsumer
