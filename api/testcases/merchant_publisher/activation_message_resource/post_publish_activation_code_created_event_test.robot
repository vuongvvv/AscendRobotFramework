*** Settings ***
Documentation    Tests to verify that publishActivationCodeCreatedEvent api works correctly
...
*** Test Cases ***
TC_O2O_08541
    [Documentation]    [merchant-publisher][publishActivationCodeCreatedEvent] Request with empty body returns 400
    [Tags]    Regression    Medium    E2E    Sanity    Smoke
    Post Publish Activation Code Created Event    RPP_OUTLET_APPROVE    ${EMPTY}
