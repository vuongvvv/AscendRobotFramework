...
*** Test Cases ***
TC_O2O_08543
    [Documentation]    [merchant-publisher][publishMerchantCreatedEvent] Request with empty body returns 400
    [Tags]    Regression    Medium    E2E    Sanity    Smoke
    Post Publish Merchant Created Event    RPP_OUTLET_APPROVE    ${EMPTY}
