*** Settings ***
Documentation    Tests to verify that publishOutletsUpdatedEvent api works correctly
...
*** Test Cases ***
TC_O2O_03484
    [Documentation]    [merchant-publisher][publishOutletsUpdatedEvent] Request with empty body returns 400
    [Tags]    Regression    Medium    E2E    Sanity    Smoke
    Put Publish Outlets Updated Event    ${EMPTY}
