*** Settings ***
Documentation    Tests to verify that publishOutletV2UpdatedEvent api works correctly
...
*** Test Cases ***
TC_O2O_08546
    [Documentation]    [merchant-publisher][publishOutletV2UpdatedEvent] Request with empty body returns 400
    [Tags]    Regression    Medium    E2E    Sanity    Smoke
    Put Publish Outlet V2 Updated Event    RPP_OUTLET_APPROVE    ${EMPTY}
