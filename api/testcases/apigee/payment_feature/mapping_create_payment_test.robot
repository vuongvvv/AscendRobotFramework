...
TC_O2O_02250
    ...
    Post Create Payment    ${external_terminal_id}    { "brandId": "${external_brand_id}", "branchId": "${external_branch_id}", "payment": { "amount": "${invalid_amount}", "currency": "${currency}", "code": "${code}", "method": "${method}", "description": "${description}" },"external": true }
...
TC_O2O_02252
    ...
    [Tags]    Regression    Medium   
    Post Create Payment    ${external_terminal_id}    { "brandId": "${external_brand_id}", "branchId": "${external_branch_id}", "payment": { "amount": "${amount}", "currency": "${currency}", "code": "${invalid_code}", "method": "${method}", "description": "${description}" },"external": true }
    Response Correct Code    ${BAD_REQUEST_CODE}
    Response Should Contain Property With Value    .code    API_3_PARTY
...
TC_O2O_02253
    ...
    [Tags]    Regression    Medium   
    Post Create Payment    ${external_terminal_id}    { "brandId": "${external_brand_id}", "branchId": "${external_branch_id}", "payment": { "amount": "${amount}", "currency": "${currency}", "code": "${code}", "method": "${invalid_method}", "description": "${description}" },"external": true }
    Response Correct Code    ${BAD_REQUEST_CODE}
    Response Should Contain Property With Value    .code    API_3_PARTY
...
TC_O2O_02254
    ...
    [Tags]    Regression    Medium   
    Post Create Payment    ${not_mapping_external_terminal_id}    { "brandId": "${external_brand_id}", "branchId": "${external_branch_id}", "payment": { "amount": "${amount}", "currency": "${currency}", "code": "${code}", "method": "${method}", "description": "${description}" },"external": true }
...
TC_O2O_02255
    ...
    [Tags]    Regression    Medium   
    Post Create Payment    ${TERMINAL_ID}    { "brandId": "${external_brand_id}", "branchId": "${external_branch_id}", "payment": { "amount": "${amount}", "currency": "${currency}", "code": "${code}", "method": "${method}", "description": "${description}" },"external": true }
    Response Correct Code    ${INTERNAL_SERVER_CODE}
    Response Should Contain Property With Value    .code    ${INTERNAL_SERVER_CODE}
    Response Should Contain Property With Value    .displayCode    m002
    Response Should Contain Property With Value    .messsage    ${internal_server_error_message}
...
TC_O2O_02256
    ...
    [Tags]    Regression    Medium   
    Post Create Payment    ${external_terminal_id}    { "brandId": "${external_brand_id}", "branchId": "${not_mapping_external_branch_id}", "payment": { "amount": "${amount}", "currency": "${currency}", "code": "${code}", "method": "${method}", "description": "${description}" },"external": true }
    Response Correct Code    ${INTERNAL_SERVER_CODE}
    Response Should Contain Property With Value    .code    ${INTERNAL_SERVER_CODE}
    Response Should Contain Property With Value    .displayCode    m002
    Response Should Contain Property With Value    .messsage    ${internal_server_error_message}
...
TC_O2O_02257
    ...
    [Tags]    Regression    Medium   
    Post Create Payment    ${external_terminal_id}    { "brandId": "${external_brand_id}", "branchId": "${BRANCH_ID}", "payment": { "amount": "${amount}", "currency": "${currency}", "code": "${code}", "method": "${method}", "description": "${description}" },"external": true }
    Response Correct Code    ${INTERNAL_SERVER_CODE}
    Response Should Contain Property With Value    .code    ${INTERNAL_SERVER_CODE}
    Response Should Contain Property With Value    .displayCode    m002
    Response Should Contain Property With Value    .messsage    ${internal_server_error_message}
...
TC_O2O_02258
    ...
    [Tags]    Regression    Medium   
    Post Create Payment    ${external_terminal_id}    { "brandId": "${not_mapping_brand_id}", "branchId": "${external_branch_id}", "payment": { "amount": "${amount}", "currency": "${currency}", "code": "${code}", "method": "${method}", "description": "${description}" },"external": true }
    Response Correct Code    ${INTERNAL_SERVER_CODE}
    Response Should Contain Property With Value    .code    ${INTERNAL_SERVER_CODE}
    Response Should Contain Property With Value    .displayCode    m002
    Response Should Contain Property With Value    .messsage    ${internal_server_error_message}
...
TC_O2O_02259
    [Documentation]    [API] [Apigee] [Create Payment] Create payment using already mapping external terminalId, branchId, and not mapping external brandId returns 500
    [Tags]    Regression    Medium   
    Post Create Payment    ${external_terminal_id}    { "brandId": "${BRAND_ID}", "branchId": "${external_branch_id}", "payment": { "amount": "${amount}", "currency": "${currency}", "code": "${code}", "method": "${method}", "description": "${description}" },"external": true }
    Response Correct Code    ${INTERNAL_SERVER_CODE}
    Response Should Contain Property With Value    .code    ${INTERNAL_SERVER_CODE}
    Response Should Contain Property With Value    .displayCode    m002
    Response Should Contain Property With Value    .messsage    ${internal_server_error_message}
...
TC_O2O_02264
    ...
    [Tags]    Regression    Medium   
    Post Create Payment    ${TERMINAL_ID}    { "brandId": "${external_brand_id}", "branchId": "${BRANCH_ID}", "payment": { "amount": "${amount}", "currency": "${currency}", "code": "${code}", "method": "${method}", "description": "${description}" },"external": false }
    Response Correct Code    ${BAD_REQUEST_CODE}
    Response Should Contain Property With Value    .code    API_3_PARTY
...
TC_O2O_02265
    ...
    [Tags]    Regression    Medium   
    Post Create Payment    ${TERMINAL_ID}    { "brandId": "${not_mapping_brand_id}", "branchId": "${BRANCH_ID}", "payment": { "amount": "${amount}", "currency": "${currency}", "code": "${code}", "method": "${method}", "description": "${description}" },"external": false }
    Response Correct Code    ${BAD_REQUEST_CODE}
    Response Should Contain Property With Value    .code    API_3_PARTY
    Response Should Contain Property With Value    .displayCode    4102
    Response Should Contain Property Matches Regex    .messsage    ${invalid_information_message_regex}
...
TC_O2O_02266
    ...
    [Tags]    Regression    Medium   
    Post Create Payment    ${external_terminal_id}    { "brandId": "${external_brand_id}", "branchId": "${external_branch_id}", "payment": { "amount": "${amount}", "currency": "${currency}", "code": "${code}", "method": "${method}", "description": "${description}" },"external": false }
    Response Correct Code    ${BAD_REQUEST_CODE}
    Response Should Contain Property With Value    .code    API_3_PARTY
    Response Should Contain Property With Value    .displayCode    4102
    Response Should Contain Property Matches Regex    .messsage    ${invalid_information_message_regex}
