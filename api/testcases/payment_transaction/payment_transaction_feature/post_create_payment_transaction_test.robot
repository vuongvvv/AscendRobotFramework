...
Test Setup    Run Keywords    Prepare Payment Transaction Test Data    AND    Generate Gateway Header With Scope and Permission    ${ROLE_USER}    ${ROLE_USER_PASSWORD}    paymentTx.create
